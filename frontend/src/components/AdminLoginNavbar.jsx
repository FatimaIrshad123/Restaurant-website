      ...
      <div>
        <div className=" flex flex-row justify-between p-5 md:px-32 px-5 bg-white shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
          ...
          <nav className="hidden md:flex flex-row items-center text-lg font-medium gap-8">
            ...
            <NavLink to="/addmenu" duration={500}
              className="hover:text-brightColor transition-all cursor-pointer">Add Menu 
            </NavLink>
            <NavLink to="/" duration={500}
              className="hover:text-brightColor transition-all cursor-pointer" onClick={() => localStorage.clear('token')}>Log out 
            </NavLink>
          </nav>
        ...
        <div
          ...
          <NavLink to="/addmenu"   duration={500}
            className="hover:text-brightColor transition-all cursor-pointer" onClick={closeMenu}> Add Menu
          </NavLink>
          <NavLink to="/"   duration={500}
            className="hover:text-brightColor transition-all cursor-pointer" onClick={() => {
